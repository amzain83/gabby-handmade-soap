...
class TwitterBootstrapHelper extends AppHelper {
	...
	/**
	 * This is a wrapper for the Form Create method, which defaults to the horizontal form style
	 */
	public function create($model = null, $options = array()) {
		if (is_array($options) && array_key_exists('class', $options)) {
			$options['class'] = (empty($options['class']) ? false : $options['class'].' form-horizontal');
		} else {
	...
	*/
	 ...
	 *   'wrap_class' => '' (an optional custom 'control-group' class)
	...
	public function checkbox($fieldName, $options = array()) {
		$options = array_merge(array(
			...
			'controls_class' => 'control-checkbox',
			), $options);
		$options['label'] = false;
